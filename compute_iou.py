...
if __name__ == "__main__":
    ...
    parser.add_argument('--gt_dir', default='./dataset/datasets/Dark_Zurich_val_anon', type=str, help='directory which stores CityScapes val gt images')
    parser.add_argument('--pred_dir', default='./result/dannet_aiuseg', type=str, help='directory which stores CityScapes val pred images')
